...
import { GraduationCap, User as UserIcon, Mail, Lock, ArrowLeft, RefreshCw, Copy, CheckCircle, Info } from 'lucide-react';
...
export default function StudentSignup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-primary-bg relative overflow-hidden">
      <Modal 
        isOpen={showModal} 
        onClose={() => navigate('/login/student')}
      ...
      >
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button onClick={() => navigate('/login/student')} className="w-full">
              Continue to Login
            </Button>
          </div>
        </div>
      ...
      >
        ...
        <Card className="p-6 md:p-8">
          <div className="text-center mb-6 md:mb-8">
            <div className="inline-flex items-center justify-center p-3 bg-white/5 rounded-xl mb-4 text-accent-amber">
              <GraduationCap className="w-8 h-8" />
            </div>
            <h2 className="text-xl md:text-2xl font-bold mb-1">Student Signup</h2>
            <p className="text-text-secondary text-xs md:text-sm">Create your ezyQuiz student account</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-text-secondary ml-1">Click the button to generate your unique ID</p>
            </div>
